...
def plotSolution(mesh, ncells, ncoords, nvars, p1, left, right, directory, exact, label, title, plt_name, save=False):
    ...
    ax.plot(pltCoords[0:tmp], (exact[:, :, 0].reshape(-1))[0:tmp], linestyle="-", linewidth=1,
            label="Exact solution", color="blue")
    ...
    ax.plot([left, pltCoords[0]], np.array([0., 0.]), linestyle="-", linewidth=1, color="blue")
    ax.plot([pltCoords[-1], right], np.array([0., 0.]), linestyle="-", linewidth=1, color="blue")

    ax.plot(pltCoords, pltPhysical, linestyle="", marker="o", label=label, markersize=2.25, color="black")
    ax.plot([left, right],
            ...
            :, 0].reshape(-1), linestyle="", marker="o", markersize=2.25, color="black")
